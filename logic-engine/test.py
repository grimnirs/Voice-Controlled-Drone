...
@pytest.mark.skip(reason="Vertical movement is suppressed by collision brake in iris_warehouse — overhead beams trigger up-brake and floor objects trigger down-brake before drone can travel 5m. Tested separately by test_up_sensor / test_down_sensor.")
@pytest.mark.asyncio
...
@pytest.mark.skip(reason="Vertical movement is suppressed by collision brake in iris_warehouse — see test_fly_up reasoning.")
@pytest.mark.asyncio
